...
I looked through [DuOTP's source code](https://github.com/scintill/DuOTP-android) (which in turn takes hints from [this script](https://github.com/revalo/duo-bypass)) to see how it does its _magic_.

<Figure
    src="/img/duo-mobile-2fa/qr.png"
    alt="Duo QR code screen"
    caption="'Activate Duo Mobile for Android' followed by a QR code and a set of instructions"
/>
