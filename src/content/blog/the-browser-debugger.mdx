...
<Figure
    src="/img/the-browser-debugger/layout.svg"
    alt="Firefox Debugger layout"
    caption="Annotated layout of the Firefox debugger — navigation, line numbers, code, flow controls, right sidebar"
/>
...
<Figure
    src="/img/the-browser-debugger/set-breakpoint-line-8.jpg"
    caption="Breakpoint set at line 8"
/>
...
<Figure
    src="/img/the-browser-debugger/paused-at-line-8.jpg"
    alt="Flow paused at line 8"
    caption="Breakpoint at line 8 activated"
/>

We can now inspect all sorts of stuff, either using the panel on the right, or by hovering over variables in the code.

<Figure
    src="/img/the-browser-debugger/variable-hover.jpg"
    caption="Hover over variables and functions to inspect them"
/>

The right sidebar also bears useful information including, for example, values of variables in various scopes.

<Figure
    src="/img/the-browser-debugger/right-sidebar.png"
    alt="The right sidebar"
    caption="The right sidebar includes 'Watch expressions', 'Breakpoints', 'Call stack', 'Scopes', 'XHR Breakpoints'"
/>
...
<Figure
    src="/img/the-browser-debugger/flow-controls.jpg"
    caption="Flow controls!"
/>
...
<Figure
    src="/img/the-browser-debugger/paused-at-if.jpg"
    caption="Paused at the `if` condition"
/>

<Figure
    src="/img/the-browser-debugger/paused-in-else.jpg"
    caption="Paused inside the `else` clause"
/>
